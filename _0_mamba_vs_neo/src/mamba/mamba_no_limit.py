...
"""
    general:
        ...
        - REPORT_TO: str
"""
SAVE_DIR = "/raid/2fitts/MasterArbeit/"
RUN_NAME = "mamba_no_limit_no_silver"
LOGGING_DIR = f"{SAVE_DIR}_0_mamba_vs_neo/logs/mamba/{RUN_NAME}"
OUTPUT_DIR = f"{SAVE_DIR}_0_mamba_vs_neo/models/mamba/{RUN_NAME}"
SEED = 42
REPORT_TO = "wandb"
#%%
"""
